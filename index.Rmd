...
bookdown::render_book(output_dir = "E:/edime/Thalis/CadernoR/inferencia/my_theme/docs")
```
...
Seja _X_ uma variável aleatória com distribuição de probabilidade ou função densidade de probabilidade $f (x|\theta)$. Sejam $X_1,X_2,...,X_n$ variáveis aleató-rias independentes e identicamente distribuídas, indicandonretiradas de uma população P.  Então, $X_1,X_2,...,X_n$ é uma amostra aleatória simples de P.
